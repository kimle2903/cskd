@extends('master')
@section('content')
    <div id="error-violate">
        <div class="row">
            <div class="col-md-11 pl-5">
                <h4 class="mb-5">
                <span class="error-violate-title">QUẢN TRỊ - LĨNH VỰC VI PHẠM</span>
                @can('error-violates.store')
                ...
                <table class="table table-bordered" id="nameTable">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Hinh lĩnh vực vi phạm</th>
     ...
     <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="addModalLabel">Thêm mới lĩnh vực vi phạm</h5>
            ...
            <div class="modal-body">
                <div class="row form-group mb-5">
                    <div class="col-5 department-label">Tên lĩnh vực vi phạm <span class="text-danger">*</span> </div>
                    <div class="col-7">
                        <input type="text" name="name" id="error-violate-name" placeholder="Nhập tên" autocomplete="off" class="form-control textTxt">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel">Chỉnh sửa lĩnh vực vi phạm</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <div class="row form-group mb-5">
                    ...
                    <div class="col-7">
                        ...
                        <input type="text" name="name" id="error-violate-name-edit" autocomplete="off" placeholder="Nhập tên" class="form-control textTxt">
                        <div class="alert-name alert-error"></div>
                    </div>
                </div>
                <div class="row">
    ...
    <script>
        $('document').ready(function(){
            ...
            $("#add-new").click(function(){
                var name =  $("#error-violate-name").val();
                $.ajaxSetup({
                    headers: {
            ...
            $("#delete-all-item").click(function(){
                ...
                $.ajax({
                    url: 'error-violates/multiDelete/',
                    data:{
                        listId: listId, 
                        _method:'GET',
                    },
            ...
            $("#saveType").click(function(){
                var name = $("#editModal #error-violate-name-edit").val();
            ...
            var dataTable = $("#nameTable").DataTable({
                ...
                responsive: true,
                ajax:{
                    url: 'error-violates/getDataAjax',
                },
                columns: dataObject,
                colReorder: {
                    fixedColumnsRight: 1,
            ...
            function addEventListener(){
                var html = '';
                html += '@can("error-violates.delete_multi")<div class="col-sm-12 col-md-3"><button class="btn btn-danger deleteAll"><img src="images/ic_btn_white_delete.svg" >Xóa tất cả</button></div>@endcan';
                ...
                $(".btn-edit").click(function(){
                    ...
                    $("#editModal #error-violate-name-edit").val(name);
                    $("#editModal #id").val(id);
                })
