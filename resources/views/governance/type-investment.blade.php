@extends('master')
@section('content')
    <div id="type-investment">
        <div class="row">
            <div class="col-md-11 pl-5">
                <h4 class="mb-5">
                <span class="type-investment-title">QUẢN TRỊ - LĨNH VỰC VI PHẠM</span>
                @can("type-investments.store")
                ...
                <table class="table table-bordered" id="nameTable">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Loại hình vi phạm</th>
     ...
     <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="addModalLabel">Thêm mới loại hình vi phạm</h5>
            ...
            <div class="modal-body">
                <div class="row form-group mb-5">
                    <div class="col-5 department-label">Tên loại hình vi phạm <span class="text-danger">*</span> </div>
                    <div class="col-7">
                        <input type="text" name="name" id="type-investment-name" placeholder="Nhập tên" autocomplete="off" class="form-control textTxt">
            ...
            <div class="modal-body">
                ...
                <div class="row form-group mb-5">
                    ...
                    <div class="col-7">
                        ...
                        <input type="text" name="name" id="type-investment-name-edit" autocomplete="off" placeholder="Nhập tên" class="form-control textTxt">
                        <div class="alert-name alert-error"></div>
                    </div>
                </div>
                <div class="row">
    ...
    <script>
        $('document').ready(function(){
            ...
            $("#add-new").click(function(){
                var name =  $("#type-investment-name").val();
                $.ajaxSetup({
                    headers: {
            ...
            $("#delete-all-item").click(function(){
                ...
                $.ajax({
                    url: 'type-investments/multiDelete/',
                    data:{
                        listId: listId, 
                        _method:'GET',
                    },
            ...
            $("#delete-item").click(function(){
                ...
                $.ajax({
                    url: 'type-investments/delete/' + id,
                    data:{
                        id: id, 
                        _method:'DELETE',
                    },
            ...
            $("#saveType").click(function(){
                ...
                $.ajax({
                    url: 'type-investments/update/'+ id,
                    data:{
                        id: id,
                        name:name,
                    }, 
            ...
            var dataTable = $("#nameTable").DataTable({
                ...
                responsive: true,
                ajax:{
                    url: 'type-investments/getDataAjax',
                },
                columns: dataObject,
                colReorder: {
                    fixedColumnsRight: 1,
            ...
            function addEventListener(){
                var html = '';
                html += ' @can("type-investments.delete_multi")<div class="col-sm-12 col-md-3"><button class="btn btn-danger deleteAll"><img src="images/ic_btn_white_delete.svg" >Xóa tất cả</button></div>@endcan';
                ...
                $(".btn-edit").click(function(){
                    ...
                    $("#editModal #type-investment-name-edit").val(name);
                    $("#editModal #id").val(id);
                })
